package com.mynotes.news.activity;
...
import com.mynotes.news.adapter.ChannelAdapter;
import com.mynotes.news.constant.NewsChannelConstant;
import com.mynotes.news.event.ChannelItemMoveEvent;
import com.mynotes.news.model.NewsChannelModel;
import com.mynotes.news.presenter.NewsChannelPresenter;
import com.mynotes.widget.ItemDragHelperCallback;
...
public class NewsChannelActivity extends BaseActivity<NewsChannelPresenter, NewsChannelModel> implements NewsChannelConstant.View {
    @Bind(R.id.toolbar)
    Toolbar toolbar;
