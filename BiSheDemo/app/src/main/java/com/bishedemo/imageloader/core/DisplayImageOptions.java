...
public final class DisplayImageOptions {
	...
	public static class Builder {
		...
		/**
		 * 预置的图片会在加载图片的时候在ImageAware进行展示
		 * 如果 {@link Builder#showImageOnLoading(int)} 也被调用设置了参数
		 * ,则此方法设定的参数会被忽略。
		 */
		 ...
		 * 此方法逻辑：
		 * 如果检测到传递过来的图片的uri为空,则把此方法设定的图片的uri传过去,展示此图片
		 * 如果{@link Builder#showImageForEmptyUri(int)} 也被调用设置了参数
		 * ,则此方法设定的参数会被忽略。
		 */
		...
		/**
		 * 
		 * 图片加载失败后需要在{@link com.bishedemo.imageloader.core.imageaware.ImageAware} 里面展示的图片
		 * @param imageRes Image resource
		 */
		...
		/**
		 * 图片加载失败后需要在{@link com.bishedemo.imageloader.core.imageaware.ImageAware} 里面展示的图片
		 * 如果{@link Builder#showImageOnFail(int)} 也被调用设置了参数
		 * ,则此方法设定的参数会被忽略。
		 */
		...
		/**
		 * {@link com.bishedemo.imageloader.core.imageaware.ImageAware
		...
		/**
		 * Sets whether {@link com.bishedemo.imageloader.core.imageaware.ImageAware
		 * image aware view} will be reset (set <b>null</b>) before image loading start
		 */
		 ...
		 * {@link com.bishedemo.imageloader.core.imageaware.ImageAware image aware view} but
