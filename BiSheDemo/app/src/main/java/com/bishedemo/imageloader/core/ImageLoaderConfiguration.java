 ...
 *******************************************************************************/
package com.bishedemo.imageloader.core;
...
import com.bishedemo.imageloader.cache.disc.DiskCache;
import com.bishedemo.imageloader.cache.disc.naming.FileNameGenerator;
import com.bishedemo.imageloader.cache.memory.MemoryCache;
import com.bishedemo.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.bishedemo.imageloader.core.assist.FlushedInputStream;
import com.bishedemo.imageloader.core.assist.ImageSize;
import com.bishedemo.imageloader.core.assist.QueueProcessingType;
import com.bishedemo.imageloader.core.decode.ImageDecoder;
import com.bishedemo.imageloader.core.download.ImageDownloader;
import com.bishedemo.imageloader.core.process.BitmapProcessor;
import com.bishedemo.imageloader.utils.L;
import com.bishedemo.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.bishedemo.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.bishedemo.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.bishedemo.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.bishedemo.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.bishedemo.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.bishedemo.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.bishedemo.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.bishedemo.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.bishedemo.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.bishedemo.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.bishedemo.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.bishedemo.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.bishedemo.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.bishedemo.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
