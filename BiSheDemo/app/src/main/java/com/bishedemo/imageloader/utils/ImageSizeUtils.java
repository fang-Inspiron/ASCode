package com.bishedemo.imageloader.utils;
...
public final class ImageSizeUtils {
	...
	// 获取OpenGL在渲染texture时允许的最大分辨率与默认的最大分辨率对比取最大值
	static {
	 ...
	 * {@link com.bishedemo.imageloader.core.imageaware.ImageAware view} parameters, configuration
